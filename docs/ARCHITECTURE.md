...
>
> 与本文配套的更窄边界文档：
> - 检索 pipeline 细节：`MEMORY_FIRST_RETRIEVAL_ARCHITECTURE.md`、`MEMORY_RETRIEVAL_REFERENCE.md`
> - 节点生命周期：`MEMORY_NODE_LIFECYCLE.md`
> - 失败记忆：`PRIOR_FAILURE_REFERENCE.md`
> - 工具表面：`TOOL_SURFACE_REFERENCE.md`
...
`LifecycleResolver`（见 `MEMORY_NODE_LIFECYCLE.md`）的职责：
...
- 检索更细的链：`MEMORY_FIRST_RETRIEVAL_ARCHITECTURE.md`、`MEMORY_RETRIEVAL_REFERENCE.md`
- 节点状态机与 lifecycle resolver：`MEMORY_NODE_LIFECYCLE.md`
- 失败记忆字段、API、PreToolUse 流程：`PRIOR_FAILURE_REFERENCE.md`
- 工具 / skill / 命令暴露表面：`TOOL_SURFACE_REFERENCE.md`
- 项目级使用说明：根目录 `README.md` / `README.zh-CN.md`
