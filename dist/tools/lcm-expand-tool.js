 ...
 *
 * Exactly matches CodeMemory's `lcm_expand` tool implementation.
 */
import { LcmExpansionEngine } from "../expansion.js";
export class LcmExpandTool {
    conversationStore;
    summaryStore;
    deps;
    expansionEngine;
    constructor(conversationStore, summaryStore, deps) {
        ...
        this.deps = deps;
        this.expansionEngine = new LcmExpansionEngine(conversationStore, summaryStore);
    }
    /**
     * Perform expansion
     */
 ...
 */
export async function createLcmExpandTool(conversationStore, summaryStore, deps) {
    const tool = new LcmExpandTool(conversationStore, summaryStore, deps);
    return {
        name: "lcm_expand",
