 ...
 *
 * Exactly matches CodeMemory's `lcm_describe` tool implementation.
 */
import { RetrievalEngine } from "../retrieval.js";
export class LcmDescribeTool {
    conversationStore;
    summaryStore;
    deps;
    retrieval;
 ...
 */
export async function createLcmDescribeTool(conversationStore, summaryStore, deps) {
    const tool = new LcmDescribeTool(conversationStore, summaryStore, deps);
    return {
        name: "lcm_describe",
