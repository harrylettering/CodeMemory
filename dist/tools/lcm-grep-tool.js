 ...
 *
 * Exactly matches CodeMemory's `lcm_grep` tool implementation.
 */
import { RetrievalEngine } from "../retrieval.js";
export class LcmGrepTool {
    conversationStore;
    summaryStore;
    deps;
    retrieval;
 ...
 */
export async function createLcmGrepTool(conversationStore, summaryStore, deps) {
    const tool = new LcmGrepTool(conversationStore, summaryStore, deps);
    return {
        name: "lcm_grep",
