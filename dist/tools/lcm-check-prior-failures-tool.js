/**
 * lcm_check_prior_failures — model-callable failure lookup.
 *
...
export class LcmCheckPriorFailuresTool {
    memoryStore;
...
export async function createLcmCheckPriorFailuresTool(memoryStore) {
    const tool = new LcmCheckPriorFailuresTool(memoryStore);
    return {
        name: "lcm_check_prior_failures",
...
//# sourceMappingURL=lcm-check-prior-failures-tool.js.map